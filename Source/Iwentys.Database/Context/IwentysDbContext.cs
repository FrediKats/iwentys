    ...
    public class IwentysDbContext : DbContext
    {
        ...
        private List<StudyGroup> getStudyGroupsList()
        {
            var result = new List<StudyGroup>
            {
                new StudyGroup
                {
                    NamePattern = "М3201", StudyProgram = new StudyProgram {Name = "ИС"}, Year = 2020
                },
                new StudyGroup
                {
                    NamePattern = "М3202", StudyProgram = new StudyProgram {Name = "ИС"}, Year = 2020
                },
                new StudyGroup
                {
                    NamePattern = "М3203", StudyProgram = new StudyProgram {Name = "ИС"}, Year = 2020
                }
            };
