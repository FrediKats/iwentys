...
namespace Iwentys.Core.Services.Implementations
{
    public class GuildTestTaskService : IGuildTestTaskService
    {
        ...
        public GuildTestTaskSolvingInfoEntity Accept(AuthorizedUser user, int guildId)
        {
            ...
            return _databaseAccessor.GuildTestTaskSolvingInfo.Create(studentGuild, user.GetProfile(_databaseAccessor.Student));
        }

        //TODO: ensure project belong to user
        public GuildTestTaskSolvingInfoEntity Submit(AuthorizedUser user, int guildId, string projectOwner, string projectName)
        {
            ...
            return _databaseAccessor.GuildTestTaskSolvingInfo.Update(testTask);
        }

        
        public GuildTestTaskSolvingInfoEntity Complete(AuthorizedUser user, int guildId, int taskSolveOwnerId)
        {
